...
\begin{itemize}
    ...
    \item O \textbf{Capítulo 3} (Desenvolvimento e Arquitetura) detalha a implementação do \textit{MinervaMesh}, com ênfase na arquitetura \textit{client-side}, nas decisões de projeto e no ambiente computacional adotado.
    \item O \textbf{Capítulo 4} (Resultados e Validação) apresenta a verificação numérica em casos com solução conhecida, seguida da aplicação em casos adicionais representativos de fluidodinâmica e transferência de calor.
