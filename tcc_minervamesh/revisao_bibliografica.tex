...
\paragraph{}A condução é descrita pela Lei de Fourier e pela equação da difusão térmica. Em regime estacionário, a formulação conduz às equações de Laplace e Poisson; em regime transiente, inclui-se o termo temporal associado ao armazenamento de energia \cite{Incropera2008,Ozisik1993,Cengel2015,Bejan1992}. Esses modelos são a base de problemas clássicos de engenharia, como dissipação em componentes eletrônicos e análise térmica de discos de freio.
...
\paragraph{}Em aplicações de alta temperatura, os termos radiativos podem se tornar relevantes no balanço térmico global \cite{Incropera2008,Cengel2015}. Embora o escopo principal deste trabalho esteja em condução e convecção, a revisão considera radiação como extensão natural para trabalhos futuros.
...
\section{Trabalhos Correlatos (Ênfase em TCCs Semelhantes)}
